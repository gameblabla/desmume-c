...
#else
	#define READ32(a,b)		MMU_read32(cpu->proc_ID, b & 0xFFFFFFFC)
	#define WRITE32(a,b,c)	MMU_write32(cpu->proc_ID,b & 0xFFFFFFFC,c)
	#define READ16(a,b)		MMU_read16(cpu->proc_ID, b & 0xFFFFFFFE)
	#define WRITE16(a,b,c)	MMU_write16(cpu->proc_ID,b & 0xFFFFFFFE,c)
