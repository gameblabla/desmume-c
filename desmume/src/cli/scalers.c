...
#define WeightB5_3(A, B)  (((((cR(A) * 5) + (cR(B) * 3)) >> 3) & 0x1f) << 11 | ((((cG(A) * 5) + (cG(B) * 3)) >> 2) & 0x3f) << 5 | ((((cB(A) * 5) + (cB(B) * 3)) >> 3) & 0x1f))
#define WeightB3_5(A, B)  (((((cR(A) * 3) + (cR(B) * 5)) >> 3) & 0x1f) << 11 | ((((cG(A) * 3) + (cG(B) * 5)) >> 2) & 0x3f) << 5 | ((((cB(A) * 3) + (cB(B) * 5)) >> 3) & 0x1f))
