    ...
    for (BlockY = 0; BlockY < 48; BlockY++)
    {
        ...
        for (BlockX = 0; BlockX < 32; BlockX++)
        {
            ...
            *(BlockDst           + 4) = WeightB5_3(Weight3_5( a7, a8), Weight3_5( b7, b8));
            ...
            a1 = *(BlockSrc + 256 *  2    );
            a2 = *(BlockSrc + 256 *  2 + 1);
            uint16_t  c1 = *(BlockSrc + 256 *  3    );
            uint16_t  c2 = *(BlockSrc + 256 *  3 + 1);
            *(BlockDst + 320 * 1    ) = WeightB2_5_1(Weight5_3( b1, b2), Weight5_3( a1, a2), Weight5_3( c1, c2));
            a3 = *(BlockSrc + 256 *  2 + 2);
            a4 = *(BlockSrc + 256 *  2 + 3);
            uint16_t  c3 = *(BlockSrc + 256 *  3 + 2);
            uint16_t  c4 = *(BlockSrc + 256 *  3 + 3);
            *(BlockDst + 320 * 1 + 1) = WeightB2_5_1(Weight2_5_1( b2, b3, b4), Weight2_5_1( a2, a3, a4), Weight2_5_1( c2, c3, c4));
            a5 = *(BlockSrc + 256 *  2 + 4);
            uint16_t  c5 = *(BlockSrc + 256 *  3 + 4);
            *(BlockDst + 320 * 1 + 2) = WeightB2_5_1(Weight1_1( b4, b5), Weight1_1( a4, a5), Weight1_1( c4, c5));
            a6 = *(BlockSrc + 256 *  2 + 5);
            a7 = *(BlockSrc + 256 *  2 + 6);
            uint16_t  c6 = *(BlockSrc + 256 *  3 + 5);
            uint16_t  c7 = *(BlockSrc + 256 *  3 + 6);
            *(BlockDst + 320 * 1 + 3) = WeightB2_5_1(Weight1_5_2( b5, b6, b7), Weight1_5_2( a5, a6, a7), Weight1_5_2( c5, c6, c7));
            a8 = *(BlockSrc + 256 *  2 + 7);
            uint16_t  c8 = *(BlockSrc + 256 *  3 + 7);
            *(BlockDst + 320 * 1 + 4) = WeightB2_5_1(Weight3_5( b7, b8), Weight3_5( a7, a8), Weight3_5( c7, c8));
 
            // -- Row 3 --
            a1 = *(BlockSrc + 256 *  4    );
            a2 = *(BlockSrc + 256 *  4 + 1);
            *(BlockDst + 320 * 2    ) = WeightB1_1(Weight5_3( c1, c2), Weight5_3( a1, a2));
            a3 = *(BlockSrc + 256 *  4 + 2);
            a4 = *(BlockSrc + 256 *  4 + 3);
            *(BlockDst + 320 * 2 + 1) = WeightB1_1(Weight2_5_1( c2, c3, c4), Weight2_5_1( a2, a3, a4));
            a5 = *(BlockSrc + 256 *  4 + 4);
            *(BlockDst + 320 * 2 + 2) = WeightB1_1(Weight1_1( c4, c5), Weight1_1( a4, a5));
            a6 = *(BlockSrc + 256 *  4 + 5);
            a7 = *(BlockSrc + 256 *  4 + 6);
            *(BlockDst + 320 * 2 + 3) = WeightB1_1(Weight1_5_2( c5, c6, c7), Weight1_5_2( a5, a6, a7));
            a8 = *(BlockSrc + 256 *  4 + 7);
            *(BlockDst + 320 * 2 + 4) = WeightB1_1(Weight3_5( c7, c8), Weight3_5( a7, a8));
            ...
            c1 = *(BlockSrc + 256 *  6    );
            c2 = *(BlockSrc + 256 *  6 + 1);
            *(BlockDst + 320 * 3    ) = WeightB1_5_2(Weight5_3( a1, a2), Weight5_3( b1, b2), Weight5_3( c1, c2));
            b3 = *(BlockSrc + 256 *  5 + 2);
            b4 = *(BlockSrc + 256 *  5 + 3);
            c3 = *(BlockSrc + 256 *  6 + 2);
            c4 = *(BlockSrc + 256 *  6 + 3);
            *(BlockDst + 320 * 3 + 1) = WeightB1_5_2(Weight2_5_1( a2, a3, a4), Weight2_5_1( b2, b3, b4), Weight2_5_1( c2, c3, c4));
            b5 = *(BlockSrc + 256 *  5 + 4);
            c5 = *(BlockSrc + 256 *  6 + 4);
            *(BlockDst + 320 * 3 + 2) = WeightB1_5_2(Weight1_1( a4, a5), Weight1_1( b4, b5), Weight1_1( c4, c5));
            b6 = *(BlockSrc + 256 *  5 + 5);
            b7 = *(BlockSrc + 256 *  5 + 6);
            c6 = *(BlockSrc + 256 *  6 + 5);
            c7 = *(BlockSrc + 256 *  6 + 6);
            *(BlockDst + 320 * 3 + 3) = WeightB1_5_2(Weight1_5_2( a5, a6, a7), Weight1_5_2( b5, b6, b7), Weight1_5_2( c5, c6, c7));
            b8 = *(BlockSrc + 256 *  5 + 7);
            c8 = *(BlockSrc + 256 *  6 + 7);
            *(BlockDst + 320 * 3 + 4) = WeightB1_5_2(Weight3_5( a7, a8), Weight3_5( b7, b8), Weight3_5( c7, c8));
 
            // -- Row 5 --
            a1 = *(BlockSrc + 256 *  7    );
            a2 = *(BlockSrc + 256 *  7 + 1);
            *(BlockDst + 320 * 4    ) = WeightB3_5(Weight5_3( c1, c2), Weight5_3( a1, a2));
            a3 = *(BlockSrc + 256 *  7 + 2);
            a4 = *(BlockSrc + 256 *  7 + 3);
            *(BlockDst + 320 * 4 + 1) = WeightB3_5(Weight2_5_1( c2, c3, c4), Weight2_5_1( a2, a3, a4));
            a5 = *(BlockSrc + 256 *  7 + 4);
            *(BlockDst + 320 * 4 + 2) = WeightB3_5(Weight1_1( c4, c5), Weight1_1( a4, a5));
            a6 = *(BlockSrc + 256 *  7 + 5);
            a7 = *(BlockSrc + 256 *  7 + 6);
            *(BlockDst + 320 * 4 + 3) = WeightB3_5(Weight1_5_2( c5, c6, c7), Weight1_5_2( a5, a6, a7));
            a8 = *(BlockSrc + 256 *  7 + 7);
            *(BlockDst + 320 * 4 + 4) = WeightB3_5(Weight3_5( c7, c8), Weight3_5( a7, a8));
